...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("secondPage", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    void InitializeUX()
    {
        ...
        var temp17 = new global::Fuse.Reactive.Data("gotoFirst");
        var temp18 = new global::Fuse.Reactive.Data("gotoSecond");
        ...
        temp21.DefaultTemplate = "firstPage";
        temp21.Templates.Add(firstPage);
        temp21.Templates.Add(secondPage);
        temp22.Columns = "1*,1*";
